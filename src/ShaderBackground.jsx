...
export const ShaderBackground = () => {
  ...
  const fsSource = `
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.02, 0.02, 0.08, 1.0); // Made background darker for better contrast
      vec4 bgColor2 = vec4(0.08, 0.02, 0.15, 1.0); // Made background darker for better contrast
